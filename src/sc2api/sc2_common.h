...
struct Rect2DI {
    ...
    Rect2DI(const Point2DI& in_from,
            const Point2DI& in_to)  // NOLINT(*-easily-swappable-parameters)
...
auto CompareDistance2D(const Point2D& a, const Point2D& b, const Point2D& datum)
    -> bool;
